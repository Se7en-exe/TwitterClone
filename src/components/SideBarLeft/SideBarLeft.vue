<template>
  <div id="sidebar-left">
    <ul>
      <li>
        <router-link to="/" tag="a"><img src="../../assets/img/TwitterLogo.svg" alt="logo" /></router-link>
      </li>
      <li>
        <router-link to="/home" tag="a">
          <svg viewBox="0 0 24 24" class="r-18jsvk2 r-4qtqp9 r-yyyyoo r-lwhw9o r-dnmrzs r-bnwqim r-1plcrui r-lrvibr">
            <g>
              <path
      ...
      <li>
        <router-link to="/profile" tag="a">
          <svg viewBox="0 0 24 24" class="r-1fmj7o5 r-4qtqp9 r-yyyyoo r-lwhw9o r-dnmrzs r-bnwqim r-1plcrui r-lrvibr">
            <g>
              <path
      ...
      <li>
        <div class="navbar-user">
          <template v-if="isLoggedIn">
            <router-link :to="{ name: 'Profile' }" class="user-profile-link" active-class="active-link">
          ...
          <template v-else>
            <router-link to="/login" active-class="active-link"><el-button type="primary" plain
                class="l1">登录</el-button></router-link>
            <router-link to="/register" active-class="active-link"><el-button type="primary" plain
                class="l1">注册</el-button></router-link>
          </template>
        </div>
      </li>
    </ul>
